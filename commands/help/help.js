...
module.exports = {
  ...
  run: async (client, message, args) => {
   ...
   let helpEmbed = new MessageEmbed()
      .setTitle("**Here are __Saturn bot__ commands**")
      ...
      .addField('Important Links ','**[Invite Me](https://discord.com/oauth2/authorize?client_id=906899294815145995&permissions=8&scope=bot%20applications.commands)** **• [Support](https://discord.gg/kB7ecN53u5)**  | **[Website](https://saturnbot.npgop.repl.co/)**')
